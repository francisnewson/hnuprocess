...
namespace fn
{
        ...
        k2pi_data_( k2pi_data), is_mc_( is_mc )
    {
        ...
        {
            scatterings = { 
                { "s33_0900_120_00_000",   0.00900, 0.0120 , 3 , 0.09, 0.0000, 3}, 
                { "s33_0110_080_00_000",   0.01100, 0.0080 , 3 , 0.09, 0.0000, 3}, 
                { "s33_0110_100_00_000",   0.01100, 0.0100 , 3 , 0.09, 0.0000, 3}, 
                { "s33_0000_000_04_150" ,  0.00100, 0.0000 , 3 , 0.04, 0.0150, 3}, 
                { "s33_0000_000_08_037" ,  0.00100, 0.0000 , 3 , 0.08, 0.0037, 3}, 
            };
        }
