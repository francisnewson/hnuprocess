...
namespace fn
{
    ...
    class Km2RecoClusters
    {
        private:
            ...
            std::vector<const fne::RecoCluster *> not_associate_clusters_;
        ...
        public:
            ...
            size_type not_associate_size() const
            { return not_associate_clusters_.size() ;}
            ...
            const_iterator not_associate_begin() const 
            { return not_associate_clusters_.begin() ; }
            ...
            const_iterator not_associate_end() const 
            { return not_associate_clusters_.end() ; }
    };
